...
include('config.php');
extract($_POST);
$useramount2 = mysqli_query($eve, "select  * from tbl_registration where user_id='" . $_SESSION['user'] . "'");
...
if ($otp == "123456" && ($user2['totalAmount'] >= $_SESSION['amount'])) {
    ...
    $query = "insert into tbl_bookings values('$bookid','$tickid','" . $_SESSION['stage'] . "','" . $_SESSION['user'] . "','" . $_SESSION['show'] . "','" . $_SESSION['screen'] . "','" . $_SESSION['seats'] . "','" . $_SESSION['amount'] . "','" . $_SESSION['date'] . "',CURDATE(),'1')";
    mysqli_query($eve, $query);
